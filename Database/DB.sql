...
CREATE TABLE IF NOT EXISTS `leadersacademy`.`NirvanaDates` (
  ...
  PRIMARY KEY (`Id`),
  INDEX `NirvanaDates_Nirvana_idx` (`NirvanaId` ASC),
...
CREATE TABLE IF NOT EXISTS `leadersacademy`.`Users` (
  ...
  INDEX `FN_User_Team_idx` (`TeamId` ASC),
  INDEX `FK_User_JoiningType_idx` (`JoiningTypeId` ASC),
...
CREATE TABLE IF NOT EXISTS `leadersacademy`.`UserWorkshop` (
  ...
  INDEX `FK_UW_User_idx` (`UserId` ASC),
  INDEX `FK_UW_Workshop_idx` (`WorkshopId` ASC),
