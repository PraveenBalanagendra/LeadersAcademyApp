...
function createDatabase()
{
	...
	myDB.transaction(function(transaction) {
		...
		transaction.executeSql('INSERT INTO content (description, english, kannada) VALUES (?,?,?)', ['Program' + 'WorkshopDetail','Leaders Academy programs are structured in the way that helps in holistic development. Workshop, GLT, CTM, Kuruskshetra, Nirvana are the few different programs.','ಸಮಗ್ರ ಅಭಿವೃದ್ಧಿಯಲ್ಲಿ ಸಹಾಯ ಮಾಡುವ ರೀತಿಯಲ್ಲಿ ಲೀಡರ್ಸ ಅಕಾಡೆಮಿ ಕಾರ್ಯಕ್ರಮಗಳನ್ನು ರಚಿಸಲಾಗಿದೆ. ವರ್ಕ್ ಶಾಪ್, ಜಿಎಲ್ಟಿ, ಸಿ.ಟಿ.ಎಂ, ಕುರುಕ್ಷೇತ್ರ, ನಿರ್ವಾಣ ಇವುಗಳು ಕೆಲವು ವಿಭಿನ್ನ ಕಾರ್ಯಕ್ರಮಗಳಾಗಿವೆ.'], null, null);
		...
		transaction.executeSql('INSERT INTO content (description, english, kannada) VALUES (?,?,?)', ['Program' + 'Kurukshetra','What YOU think is what YOU become. What YOU give is what YOU get. Kurukshetra gives the clarity on the choice of Good (Relationship, Confidence, Enlightenment, Parenting, Success, Devotion etc)','ನೀವು ಏನು ಯೋಚಿಸುತ್ತೀರೋ ಅದೇ ನೀವು ಆಗುವಿರಿ. ನೀವು ಏನು ಕೊಡುತ್ತೀರಿ ಅದೇ ನಿಮಗೆ ಸಿಗುತ್ತದೆ. ಒಳ್ಳೆಯ ಆಯ್ಕೆಗಳ ಬಗ್ಗೆ ಕುರುಕ್ಷೇತ್ರವು ಸ್ಪಷ್ಟತೆ ನೀಡುತ್ತದೆ (ಸಂಬಂಧ, ವಿಶ್ವಾಸ, ಜ್ಞಾನೋದಯ, ಪೋಷಕತ್ವ, ಯಶಸ್ಸು, ಭಕ್ತಿ ಇತ್ಯಾದಿ)'], null, null);
